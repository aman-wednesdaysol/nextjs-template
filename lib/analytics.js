...
export const captureLeftAt = (trackId, secondsPlayed, percentPlayed) => {
...
export const captureMilestone = (trackId, milestonePercent, secondsPlayed) => {
...
export const captureCompleted = (trackId) => {
  posthog.capture(EVENTS.SONG_COMPLETED, {
    track_id: trackId,
    timestamp: new Date().toISOString()
  });
};
