...
export const selectSearchResults = () =>
  createSelector(selectSearchDomain, (substate) => get(substate, PAYLOAD.DATA, []));

export const selectSearchTerm = () =>
  createSelector(selectSearchDomain, (substate) => get(substate, SEARCH_PAYLOAD.SEARCH_TERM, ''));

export const selectSearchLoading = () =>
  createSelector(selectSearchDomain, (substate) => get(substate, PAYLOAD.LOADING, false));

export const selectSearchError = () =>
  createSelector(selectSearchDomain, (substate) => get(substate, PAYLOAD.ERROR, null));
